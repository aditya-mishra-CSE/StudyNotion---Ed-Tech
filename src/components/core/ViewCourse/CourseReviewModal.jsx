    ...
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-opacity-10 backdrop-blur-sm">
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-[#6E727F] bg-[#161D29]">
        ...
        <div className="p-6">
          ...
          >
            <StarRatings
              rating={watch("courseRating")} // 👈 this reads the value
              // When you call watch("courseRating"), you're watching the value of the form field called "courseRating"
              // Click stars → Form updates → watch gets value → Stars show correct number
