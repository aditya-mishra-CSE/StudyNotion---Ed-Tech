        ...
        <div className='flex flex-col lg:flex-row gap-20 mb-20 items-center'>
                    ...
                    timeline.map( (element, index) => {
                        return (
                            <div className='flex flex-col lg:gap-3' key={index}> 
                                ...
                                {index < 3 && (
                                    <div className='hidden lg:block h-14 border-dotted border-r border-[#AFB2BF] bg-[#6E727F]/0 w-[26px]'></div>
                                )}
                            </div>
                        )
                    } )
            ...
            <div className='relative w-fit h-fit shadow-[#118AB2] shadow-[0px_0px_30px_0px]'>
                <div className='absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-[#014A32] flex lg:flex-row flex-col text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10 '>
                    <div className='flex gap-5 items-center lg:border-r border-[#05A77B] px-7 lg:px-14'>
                        <p className='text-3xl font-bold w-[75px]'>10</p>
                        <p className='text-[#05A77B] text-sm w-[75px]'>years experience</p>
                    </div>
                    <div className='flex gap-5 items-center lg:px-14 px-7'>
                        <p className='text-3xl font-bold w-[75px]'>250</p>
                        <p className='text-[#05A77B] text-sm w-[75px]'>Types of courses</p>
                    </div>
                </div>
