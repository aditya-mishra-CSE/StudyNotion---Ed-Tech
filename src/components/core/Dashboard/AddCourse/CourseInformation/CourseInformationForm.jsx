...
export default function CourseInformationForm() {
    ...
    const isFormUpdated = () => {
        ...
        console.log("currentValues.courseTags:", currentValues.courseTags);
        console.log("course.tag:", course.tag);
        console.log("currentValues.courseRequirements:", currentValues.courseRequirements);
            ...
            <div className="flex justify-end gap-x-2">
                {editCourse && (
                    <button
                        ...
                        disabled={loading}
                        className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-richblack-300 py-[8px] px-[20px] font-semibold text-[#000814]`}
                    >
