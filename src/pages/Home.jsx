  ...
  return (
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 items-center 
         max-w-[1260px] text-white justify-between'>
             {/* Become a Instructor Button */}
            <Link to={"/signup"}>
                <div className='group mt-16 p-1 mx-auto rounded-full bg-[#161D29] font-bold 
                text-[#999DAA] drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 w-fit hover:drop-shadow-none'>
        ...
        <div className='bg-[#F9F9F9] text-[#2C333F]'>
            ...
            <div className='mx-auto w-11/12 max-w-[1260px] flex flex-col items-center justify-between
            gap-7'>
        ...
        <div className="relative mx-auto my-20 flex w-11/12 max-w-[1260px] flex-col items-center justify-between gap-8 bg-[#000814] text-white">
            ...
            <h1 className="text-center text-3xl lg:text-4xl font-semibold mt-8 flex justify-center items-center gap-x-3">
                Reviews from other learners <MdOutlineRateReview className='text-[#FFE83D]' />
            </h1>
