            ...
            <OtpInput
              ...
              renderInput={(props) => (
                <input
                  ...
                  className="w-[48px] lg:w-[60px] border-0 bg-richblack-800 rounded-[0.5rem] text-[#F1F2FF] aspect-square text-center focus:border-0 focus:outline-2 focus:outline-[#FFD60A]"
                />
              )}
              containerStyle={{
